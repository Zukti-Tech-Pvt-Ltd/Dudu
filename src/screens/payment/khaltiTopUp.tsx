...
import { khaltiTopUpPayment } from '../../api/khaltiApi';
    ...
    useEffect(() => {
        ...
        async function fetchPidx() {
            try {
                ...
                const response = await khaltiTopUpPayment(
                    claim?.userId,
                    priceInRs,
                    fcmToken,
                );
                        ...
                        if (url.startsWith(returnUrl)) {
                            ...
                            if (status === 'Completed') {
                                ...
                                showStatus(
                                    'success',
                                    'Payment Success',
                                    `Your payment of ${totalPrice} successfully added to your wallet.`,
                                    handleCompletion,
                                );
