...
import { Alert, Modal, Pressable, Text, Touchable, TouchableOpacity, View } from 'react-native';
  ...
  return (
    <>
      <TouchableOpacity
        ...
        activeOpacity={0.8}
      >
        <Text className="text-red-600 font-semibold text-base mr-2">{'\u2192'}</Text>
      ...
      <Modal transparent visible={visible} animationType="fade">
        ...
        >
          <Pressable className="bg-white w-72 rounded-xl p-6" onPress={e => e.stopPropagation()}>
            <Text className="text-lg font-bold mb-4">Confirm Logout</Text>
            <Text className="text-base mb-6">Are you sure you want to log out?</Text>
            <View className="flex-row justify-end space-x-4">
              ...
              >
                <Text className="text-white font-semibold text-base text-center">Yes, Log Out</Text>
              </TouchableOpacity>
            </View>
          </Pressable>
        </Pressable>
